...
RUN = Path("/scratch/jshen/data/pansoma_v2_tensors/Liss_lab_Northeastern-ONT-UL-20241216")
GAM = "/scratch/jshen/data/HG008_GIAB/raw_sequencing_data/Liss_lab_Northeastern-ONT-UL-20241216/HG008-T_GRCh38_GIABv3_ONT-UL-R10.4.1-dorado_0.8.1_sup.5mC_5hmC_54x_20241216.AF-HPRC.sorted.gam"
...
TRUTH = "/scratch/jshen/data/pansoma_v2_tensors/Liss_lab_Northeastern-ONT-UL-20241216/truth/somatic.graph.tsv"
...
def loci():
    status = {}
    with open(RUN / "v3_tensors/somatic.recall.tsv") as f:
