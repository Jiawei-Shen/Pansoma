"""Somatic SNVs with vs without a candidate: GRCh38 node length at the site, germline variants at / near the site."""
...
from indexed_gam_pipeline_v2.tensor_postprocessing.truth_labels import Locator
csv.field_size_limit(sys.maxsize)
R = "/scratch/jshen/data/pansoma_v2_tensors/Liss_lab_PacBio_Revio_20240125/v5_tensors"
