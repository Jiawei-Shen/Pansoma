"""Graph index reader contract; native builder tests run only when the tools are configured."""
import os
...
from fixtures import graph_fixture  # noqa: F401  (sets sys.path)
from indexed_gam_pipeline_v2.graph_index import GraphIndex, build_index
