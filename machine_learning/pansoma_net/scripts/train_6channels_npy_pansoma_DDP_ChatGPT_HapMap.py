...
class ShardPrefetcher:
    ...
    IMPORTANT:
      - We use mmap_mode="r" to avoid loading full shards into RAM.
      - max_prefetch kept small to reduce open-file pressure.
    """
        ...
        for local_order_idx, shard, x_np, y_np in prefetcher:
            ...
            while start < n:
                if max_steps is not None and yielded >= max_steps:
                    return  # ends generator -> finally runs -> prefetch stops
